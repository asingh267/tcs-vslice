...
public class EcsConfig {
	...
	public static final DoubleKey xDemandKey = new DoubleKey("tcs.str.ecs.x");
	public static final DoubleKey yDemandKey = new DoubleKey("tcs.str.ecs.y");
	...
	public static final DoubleKey x = new DoubleKey("tcs.ecs.x");
	public static final DoubleKey y = new DoubleKey("tcs.ecs.y");
