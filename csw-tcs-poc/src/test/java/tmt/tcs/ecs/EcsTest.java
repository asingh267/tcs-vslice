...
public class EcsTest extends JavaTestKit {
	...
	public static void setup() throws Exception {
		System.out.println("Inside EcsTest setup");
	...
	@Test
	public void test1() {
		System.out.println("Inside EcsTest test1 Move Command");
		...
		System.out.println("Inside EcsTest test1 Command Accepted Result: " + acceptedMsg);

		CommandResult completeMsg = fakeClient.expectMsgClass(duration("3 seconds"), CommandResult.class);
		System.out.println("Inside EcsTest test1 Command Result: " + completeMsg.details().status(0));
	...
	@Test
	public void test2() {
		System.out.println("Inside EcsTest test2 Offset Command");
		...
		SetupConfig offsetSc = jadd(new SetupConfig(EcsConfig.offsetDemandCK.prefix()),
			      jset(EcsConfig.xDemandKey, xValue),
			      jset(EcsConfig.yDemandKey, yValue));
		...
		CommandResult acceptedMsg = fakeClient.expectMsgClass(duration("3 seconds"), CommandResult.class);
		assertEquals(acceptedMsg.overall(), Accepted);
		System.out.println("Inside EcsTest test2 Command Accepted Result: " + acceptedMsg);

		CommandResult completeMsg = fakeClient.expectMsgClass(duration("3 seconds"), CommandResult.class);
		System.out.println("Inside EcsTest test2 Command Result: " + completeMsg.details().status(0));
	...
	public static void teardown() throws InterruptedException {
		System.out.println("Inside EcsTest teardown");
